...
wp_enqueue_style('wmcz-plugin', plugin_dir_url(__FILE__) . 'static/stylesheet.css');
wp_enqueue_script('wmcz-plugin', plugin_dir_url(__FILE__) . 'static/map.js');
wp_enqueue_script('leaflet', plugin_dir_url(__FILE__) . 'static/leaflet/dist/leaflet.js');
wp_enqueue_style('leaflet', plugin_dir_url(__FILE__) . 'static/leaflet/dist/leaflet.css');